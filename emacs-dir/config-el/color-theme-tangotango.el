...
(defun color-theme-tangotango ()
  ...
  (color-theme-install
   '(color-theme-tangotango
     ...
     (mode-line ((t (:foreground "#bbbbbc" :background "#222222" :box (:line-width 1 :color "#222222")))))
     ...
     (gnus-cite-face-2 ((t (:foreground "tomato"))))
     ...
     (gnus-summary-low-ticked((t (:italic t :foreground "tomato"))))
     ...
     (gnus-summary-normal-ticked((t (:foreground "tomato"))))
     (gnus-summary-normal-unread((t (:foreground "white"))))
     (gnus-summary-selected ((t (:background "tomato" :foreground "white"))))
     ...
     ;; COMMENT: this is where my own stuff starts
      (erc-default-face ((t (:foreground "#eeeeec"))))
      (erc-direct-msg-face ((t (:foreground "tomato"))))
      (erc-input-face ((t (:foreground "#bbbbbc"))))
      (erc-prompt-face ((t (:foreground "#edd400" :weight bold))))
      (erc-notice-face ((t (:foreground "#eeeeec"))))
      (erc-timestamp-face ((t (:foreground "#6ac214" :weight bold))))
      (erc-current-nick-face ((t (:foreground "tomato"))))
      (erc-my-nick-face ((t (:foreground "tomato" :weight bold))))
      (erc-nick-msg-face ((t (:foreground "tomato"))))
      (ido-subdir ((t (:foreground "tomato" :weight bold))))
)))
