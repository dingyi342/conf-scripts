...
(setq user-mail-address "priestsyrinx@gmail.com" ;; user mail address (could use my school mail)
      user-full-name "Brandon R Betances" ;; user full-name
...
(setq gnus-select-method '(nnml "")
      ...
      gnus-posting-styles '((".*" (name "Brandon R Betances"))
			    ("gmail" (address "priestsyrinx@gmail.com"))))
